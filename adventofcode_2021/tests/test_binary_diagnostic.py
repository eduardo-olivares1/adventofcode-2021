...
def test_common_bit():
    assert binary_diagnostic.get_common_bit([0,1,1,1,1]) == 1
    assert binary_diagnostic.get_common_bit([1,0,0,0,0]) == 0
    assert binary_diagnostic.get_common_bit([1,0,1,0,1]) == 1
